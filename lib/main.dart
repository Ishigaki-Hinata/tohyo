              ...
              children: <Widget>[
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(hintText: "予定のタイトルを入力"),
                  ),
                ),
                SizedBox(
                  height: 15,
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(hintText: "予定のメモを入力"),
                  ),
                ),
                SizedBox(
                  height: 15,
                ...
                Text("リマインダー： 登録日時の $reminderTimingO $reminderUnitO"),
                SizedBox(
                  height: 15,
                ),
                ...
                Container(
                  ...
                  child: TextFormField(
                    ...
                    decoration: InputDecoration(hintText: "アクセスしたい予定IDを貼り付け"),
    ...
    try {
      await googleCalendarApiO.events.get(calendarIdO, scheduleIdO).then(
        ...
        (valueO) {
          ...
          print(
              "タイトル:${valueO.summary}, 予定日時:${valueO.start!.dateTime!.toLocal().toString()}, リマインダー:${valueO.reminders!.overrides![0].minutes}分前 (方法:${valueO.reminders!.overrides![0].method}), メモ:${valueO.description}");
        },
      );
